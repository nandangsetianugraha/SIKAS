...
function TanggalIndo($tanggal)
{
 ...
 $table1=new easyTable($pdf, '{10,65,15,2,10,65,15}');
 $table1->easyCell('', 'img:logo1.jpg, align:C;valign:M');
 $table1->easyCell("KARTU TANDA PESERTA", 'valign:M;align:C;font-size:12;font-style:B;paddingY:0.3');
 $table1->easyCell('', 'img:logo1.jpg, align:C;valign:M');
