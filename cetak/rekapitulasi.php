...
/**
	...
	**/	
		...
		//$table2->easyCell('Jum Tung.','align:C;valign:M;border:1');
		...
		if($kelas==="lainnya"){
			...
			while($namasis=$nsis->fetch_assoc()){
					...
					if($tarifnya['tarif']==0){
						...
						if($cek>0){
							...
							if($sudah==$tarifnya['tarif']){
								...
								//$table2->easyCell($sisanya,'align:R;valign:M;border:1');
							...
							//$table2->easyCell($tarifnya['tarif'],'align:R;valign:M;border:1');
				...
				//$table2->easyCell(rupiah($stun),'align:R;valign:M;border:1');
				...
				//$table2->easyCell($saldo,'align:R;valign:M;border:1');
				$sisatab=$saldo-$stun;
				if($sisatab>0){
					$table2->easyCell(rupiah($sisatab),'align:R;valign:M;border:1');
					//$table2->easyCell($sisatab,'align:R;valign:M;border:1');
					$table2->easyCell('','align:R;valign:M;border:1');
					...
					//$table2->easyCell($stun-$saldo,'align:R;valign:M;border:1');
