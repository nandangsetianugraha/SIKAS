		...
		$validator['messages'] = "Isi Tanggal Bro";
			...
			while($r = $query->fetch_assoc()){
				...
				if($jns==1){
					...
					$qmove = $connect->query("INSERT INTO pembayaran(id_invoice,tanggal,peserta_didik_id,tapel,jenis,deskripsi,bayar) VALUES('$kode','$tanggal','$idpd','$tapel','$jns','$desk','$byr')");
				}
			};
