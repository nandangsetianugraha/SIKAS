...
while ($row = $query->fetch_assoc()) {
	...
	$actionButton = '
		...
		<button class="btn btn-sm btn-danger" data-nasabah="'.$idn.'" id="getBlanko"><i class="fas fa-print"></i>B</button>
		<button class="btn btn-sm btn-danger" data-nasabah="'.$idn.'" id="getCover"><i class="fas fa-print"></i>C</button>
		';	
	$namasis=$row['nama'];
	$output['data'][] = array(
		$row['nasabah_id'],
