        ...
        var smt=$('#smt').val();
			if(siswa==0){
				...
				$.ajax({
					...
					data :  'siswa=' + siswa+'&bulan='+bulan+'&jenis='+jenis+'&tapel='+tapel+'&smt='+smt,
					beforeSend: function()
					{	
		...
		$(document).on('click', '#cetaklaporan', function(e){
          ...
          var smt=$('#smt').val();
			if(siswa==0){
				...
				PopupCenter('../cetak/cetak-tunggakan.php?siswa='+siswa+'&bulan='+bulan+'&jenis='+jenis+'&tapel='+tapel+'&smt='+smt, 'Cetak Invoice',800,800);
			}
